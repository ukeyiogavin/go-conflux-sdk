...
install from remote
```
$ go install github.com/ukeyiogavin/go-conflux-sdk/cmd/cfxabigen
```
...
1. download the code
```
$ git clone https://github.com/ukeyiogavin/go-conflux-sdk.git
```
...
import (
	...
	sdk "github.com/ukeyiogavin/go-conflux-sdk"
	"github.com/ukeyiogavin/go-conflux-sdk/middleware"
	"github.com/ukeyiogavin/go-conflux-sdk/types"
	"github.com/ukeyiogavin/go-conflux-sdk/types/cfxaddress"
