...
// ERC20Session is an auto generated Go binding around an Conflux contract,
...
// ERC20CallerSession is an auto generated read-only Go binding around an Conflux contract,
...
// ERC20TransactorSession is an auto generated write-only Go binding around an Conflux contract,
...
func NewERC20BulkCaller(address types.Address, caller bind.ContractCaller) (*ERC20BulkCaller, error) {
	...
	return &ERC20BulkCaller{contract: contract}, nil
}
...
func NewERC20BulkTransactor(address types.Address, transactor bind.ContractTransactor) (*ERC20BulkTransactor, error) {
	...
	return &ERC20BulkTransactor{contract: contract}, nil
}

// bindERC20 binds a generic wrapper to an already deployed contract.
func bindERC20(address types.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ERC20 *ERC20TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.UnsignedTransaction, *types.Hash, error) {
...
func (_ERC20 *ERC20Caller) Allowance(opts *bind.CallOpts, owner common.Address, spender common.Address) (*big.Int, error) {
	var out []interface{}
	__err := _ERC20.contract.Call(opts, &out, "allowance", owner, spender)
...
func (_ERC20 *ERC20BulkCaller) Allowance(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, owner common.Address, spender common.Address) (**big.Int, *error) {
	...
	__request := _ERC20.contract.GenRequest(opts, "allowance", owner, spender)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC20.contract.DecodeOutput(&out, rawOut, "allowance")
		if err != nil {
			return err
		}
...
func (_ERC20 *ERC20Caller) BalanceOf(opts *bind.CallOpts, account common.Address) (*big.Int, error) {
	var out []interface{}
	__err := _ERC20.contract.Call(opts, &out, "balanceOf", account)
...
func (_ERC20 *ERC20BulkCaller) BalanceOf(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, account common.Address) (**big.Int, *error) {
	...
	__request := _ERC20.contract.GenRequest(opts, "balanceOf", account)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC20.contract.DecodeOutput(&out, rawOut, "balanceOf")
		if err != nil {
			return err
		}
...
func (_ERC20 *ERC20Caller) TotalSupply(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	__err := _ERC20.contract.Call(opts, &out, "totalSupply")
...
func (_ERC20 *ERC20BulkCaller) TotalSupply(bulkcaller bulk.BulkCaller, opts *bind.CallOpts) (**big.Int, *error) {
	...
	__request := _ERC20.contract.GenRequest(opts, "totalSupply")
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC20.contract.DecodeOutput(&out, rawOut, "totalSupply")
		if err != nil {
			return err
		}
...
func (_ERC20 *ERC20BulkTransactor) Approve(opts *bind.TransactOpts, spender common.Address, amount *big.Int) types.UnsignedTransaction {
	return _ERC20.contract.GenUnsignedTransaction(opts, "approve", spender, amount)
}
...
func (_ERC20 *ERC20BulkTransactor) Transfer(opts *bind.TransactOpts, recipient common.Address, amount *big.Int) types.UnsignedTransaction {
	return _ERC20.contract.GenUnsignedTransaction(opts, "transfer", recipient, amount)
}
...
func (_ERC20 *ERC20BulkTransactor) TransferFrom(opts *bind.TransactOpts, sender common.Address, recipient common.Address, amount *big.Int) types.UnsignedTransaction {
	return _ERC20.contract.GenUnsignedTransaction(opts, "transferFrom", sender, recipient, amount)
}
...
func (_ERC20 *ERC20Filterer) FilterApproval(opts *bind.FilterOpts, owner []common.Address, spender []common.Address) (*ERC20ApprovalIterator, error) {
	...
	logs, err := _ERC20.contract.FilterLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return &ERC20ApprovalIterator{contract: _ERC20.contract, event: "Approval", logs: logs}, nil
}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ERC20ApprovalOrChainReorg)
				event.Event = new(ERC20Approval)

				if log.ChainReorg == nil {
					if err := _ERC20.contract.UnpackLog(event.Event, "Approval", *log.Log); err != nil {
						return err
					}
...
func (_ERC20 *ERC20Filterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*ERC20TransferIterator, error) {
	...
	logs, err := _ERC20.contract.FilterLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &ERC20TransferIterator{contract: _ERC20.contract, event: "Transfer", logs: logs}, nil
}
...
func (_ERC20 *ERC20Filterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *ERC20TransferOrChainReorg, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20TransferOrChainReorg)
				event.Event = new(ERC20Transfer)

				if log.ChainReorg == nil {
					if err := _ERC20.contract.UnpackLog(event.Event, "Transfer", *log.Log); err != nil {
						return err
					}
					event.Event.Raw = *log.Log
				} else {
