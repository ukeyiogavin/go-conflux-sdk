...
// ERC721Session is an auto generated Go binding around an Conflux contract,
...
// ERC721CallerSession is an auto generated read-only Go binding around an Conflux contract,
...
// ERC721TransactorSession is an auto generated write-only Go binding around an Conflux contract,
...
func NewERC721BulkCaller(address types.Address, caller bind.ContractCaller) (*ERC721BulkCaller, error) {
	...
	return &ERC721BulkCaller{contract: contract}, nil
}
...
func NewERC721BulkTransactor(address types.Address, transactor bind.ContractTransactor) (*ERC721BulkTransactor, error) {
	...
	return &ERC721BulkTransactor{contract: contract}, nil
}

// bindERC721 binds a generic wrapper to an already deployed contract.
func bindERC721(address types.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ERC721 *ERC721TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.UnsignedTransaction, *types.Hash, error) {
...
func (_ERC721 *ERC721Caller) BalanceOf(opts *bind.CallOpts, owner common.Address) (*big.Int, error) {
	var out []interface{}
	__err := _ERC721.contract.Call(opts, &out, "balanceOf", owner)
...
func (_ERC721 *ERC721BulkCaller) BalanceOf(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, owner common.Address) (**big.Int, *error) {
	...
	__request := _ERC721.contract.GenRequest(opts, "balanceOf", owner)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC721.contract.DecodeOutput(&out, rawOut, "balanceOf")
		if err != nil {
			return err
		}
...
func (_ERC721 *ERC721Caller) GetApproved(opts *bind.CallOpts, tokenId *big.Int) (common.Address, error) {
	var out []interface{}
	__err := _ERC721.contract.Call(opts, &out, "getApproved", tokenId)
...
func (_ERC721 *ERC721BulkCaller) GetApproved(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, tokenId *big.Int) (*common.Address, *error) {
	...
	__request := _ERC721.contract.GenRequest(opts, "getApproved", tokenId)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC721.contract.DecodeOutput(&out, rawOut, "getApproved")
		if err != nil {
			return err
		}
...
func (_ERC721 *ERC721Caller) IsApprovedForAll(opts *bind.CallOpts, owner common.Address, operator common.Address) (bool, error) {
	var out []interface{}
	__err := _ERC721.contract.Call(opts, &out, "isApprovedForAll", owner, operator)
...
func (_ERC721 *ERC721BulkCaller) IsApprovedForAll(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, owner common.Address, operator common.Address) (*bool, *error) {
	...
	__request := _ERC721.contract.GenRequest(opts, "isApprovedForAll", owner, operator)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC721.contract.DecodeOutput(&out, rawOut, "isApprovedForAll")
		if err != nil {
			return err
		}
...
func (_ERC721 *ERC721Caller) OwnerOf(opts *bind.CallOpts, tokenId *big.Int) (common.Address, error) {
	var out []interface{}
	__err := _ERC721.contract.Call(opts, &out, "ownerOf", tokenId)
...
func (_ERC721 *ERC721BulkCaller) OwnerOf(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, tokenId *big.Int) (*common.Address, *error) {
	...
	__request := _ERC721.contract.GenRequest(opts, "ownerOf", tokenId)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC721.contract.DecodeOutput(&out, rawOut, "ownerOf")
		if err != nil {
			return err
		}
...
func (_ERC721 *ERC721Caller) SupportsInterface(opts *bind.CallOpts, interfaceId [4]byte) (bool, error) {
	var out []interface{}
	__err := _ERC721.contract.Call(opts, &out, "supportsInterface", interfaceId)
...
func (_ERC721 *ERC721BulkCaller) SupportsInterface(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, interfaceId [4]byte) (*bool, *error) {
	...
	__request := _ERC721.contract.GenRequest(opts, "supportsInterface", interfaceId)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _ERC721.contract.DecodeOutput(&out, rawOut, "supportsInterface")
		if err != nil {
			return err
		}
...
func (_ERC721 *ERC721BulkTransactor) Approve(opts *bind.TransactOpts, to common.Address, tokenId *big.Int) types.UnsignedTransaction {
	return _ERC721.contract.GenUnsignedTransaction(opts, "approve", to, tokenId)
}
...
func (_ERC721 *ERC721BulkTransactor) SafeTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int) types.UnsignedTransaction {
	return _ERC721.contract.GenUnsignedTransaction(opts, "safeTransferFrom", from, to, tokenId)
}
...
func (_ERC721 *ERC721BulkTransactor) SafeTransferFrom0(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int, data []byte) types.UnsignedTransaction {
	return _ERC721.contract.GenUnsignedTransaction(opts, "safeTransferFrom0", from, to, tokenId, data)
}
...
func (_ERC721 *ERC721BulkTransactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, _approved bool) types.UnsignedTransaction {
	return _ERC721.contract.GenUnsignedTransaction(opts, "setApprovalForAll", operator, _approved)
}
...
func (_ERC721 *ERC721BulkTransactor) TransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int) types.UnsignedTransaction {
	return _ERC721.contract.GenUnsignedTransaction(opts, "transferFrom", from, to, tokenId)
}
...
func (_ERC721 *ERC721Filterer) FilterApproval(opts *bind.FilterOpts, owner []common.Address, approved []common.Address, tokenId []*big.Int) (*ERC721ApprovalIterator, error) {
	...
	logs, err := _ERC721.contract.FilterLogs(opts, "Approval", ownerRule, approvedRule, tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &ERC721ApprovalIterator{contract: _ERC721.contract, event: "Approval", logs: logs}, nil
}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ERC721ApprovalOrChainReorg)
				event.Event = new(ERC721Approval)

				if log.ChainReorg == nil {
					if err := _ERC721.contract.UnpackLog(event.Event, "Approval", *log.Log); err != nil {
						return err
					}
...
func (_ERC721 *ERC721Filterer) FilterApprovalForAll(opts *bind.FilterOpts, owner []common.Address, operator []common.Address) (*ERC721ApprovalForAllIterator, error) {
	...
	logs, err := _ERC721.contract.FilterLogs(opts, "ApprovalForAll", ownerRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return &ERC721ApprovalForAllIterator{contract: _ERC721.contract, event: "ApprovalForAll", logs: logs}, nil
}
...
func (_ERC721 *ERC721Filterer) WatchApprovalForAll(opts *bind.WatchOpts, sink chan<- *ERC721ApprovalForAllOrChainReorg, owner []common.Address, operator []common.Address) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC721ApprovalForAllOrChainReorg)
				event.Event = new(ERC721ApprovalForAll)

				if log.ChainReorg == nil {
					if err := _ERC721.contract.UnpackLog(event.Event, "ApprovalForAll", *log.Log); err != nil {
						return err
					}
					event.Event.Raw = *log.Log
				} else {
...
func (_ERC721 *ERC721Filterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address, tokenId []*big.Int) (*ERC721TransferIterator, error) {
	...
	logs, err := _ERC721.contract.FilterLogs(opts, "Transfer", fromRule, toRule, tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &ERC721TransferIterator{contract: _ERC721.contract, event: "Transfer", logs: logs}, nil
}
...
func (_ERC721 *ERC721Filterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *ERC721TransferOrChainReorg, from []common.Address, to []common.Address, tokenId []*big.Int) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC721TransferOrChainReorg)
				event.Event = new(ERC721Transfer)

				if log.ChainReorg == nil {
					if err := _ERC721.contract.UnpackLog(event.Event, "Transfer", *log.Log); err != nil {
						return err
					}
					event.Event.Raw = *log.Log
				} else {
